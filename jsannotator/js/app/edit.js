...
/*    var file_data = annotator.export();
    document.getElementById('hidden_data').value = file_data;
    var fd = new FormData();	
	var formData = dataURItoBlob(file_data);
	fd.append('hidden_data', file_data);
    var xhr = new XMLHttpRequest();
    xhr.open('POST', 'http://shannon.cs.umass.edu/sheldon/birdcast/AppProjectCopy/js-segment-annotator/upload_data.php', true);
                
    xhr.send(fd);
      
//upload the file      http://codular.com/javascript-ajax-file-upload-with-progress
// xhr
/*
var userName = params.user;
var http = new XMLHttpRequest();
var url = "http://shannon.cs.umass.edu/sheldon/birdcast/AppProjectCopy/js-segment-annotator/save.php";
var file_data = annotator.export();
var formData = dataURItoBlob(file_data);
...
http.send(fd);
 ...
 var form_data = new FormData();                  
    ...
    alert(form_data);                             
    $.ajax({
                url: 'http://shannon.cs.umass.edu/sheldon/birdcast/AppProjectCopy/js-segment-annotator/upload.php', // point to server-side PHP script 
